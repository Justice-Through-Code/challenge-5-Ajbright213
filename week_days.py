...
#     # AFTER your loop, print out the list to check if it got populated correctly.
    ...
    for sing_d in days:
     fav_thing = input(f'What is your favorite thing to do on {sing_d}')
     favorite_activities.append(fav_thing)
...
#     # tell the user to 'Put on some sunscreen!'.
    ...
    for sing_d in days:
        temp = int(input(f'Today is {sing_d} what is the temperature outside?'))
        if temp < 50:
